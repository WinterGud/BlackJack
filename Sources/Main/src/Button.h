    ...
    private:
        std::function<void(Args...)> m_callbackFunction;
    };

    template <typename... Args>
    Button<Args...>::Button(int x, int y, int w, int h, const std::string& mainTexturePath,
    ...
    template <typename... Args>
    Button<Args...>::Button(const Button& other)
    ...
    template <typename... Args>
    void Button<Args...>::update()
    {
    }

    template <typename... Args>
    void Button<Args...>::takeFunction(const std::function<void(Args...)>& function)
    {
        m_callbackFunction = function;
    }

    template <typename... Args>
    bool Button<Args...>::checkPressed(int x, int y) const
    {
    ...
    template <typename... Args>
    void Button<Args...>::triggerFunction(Args... args)
    {
    ...
    template <typename... Args>
    bool Button<Args...>::checkTextures() const
    {
